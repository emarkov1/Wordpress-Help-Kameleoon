...
<div class="probox">
    ...
    <div class='proinput'>
        <form autocomplete="off" aria-label='Ajax search form'>
            <input aria-label='Search input' type='search' class='orig' name='phrase' placeholder='<?php $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; if (preg_match('/de/',$actual_link,$matches) ) echo 'Suche...';elseif( preg_match('/fr/',$actual_link,$matches) )echo 'Recherche...';else echo 'Search for...' ?>' value='<?php echo apply_filters('asl_print_search_query', get_search_query()); ?>' autocomplete="off"/>
