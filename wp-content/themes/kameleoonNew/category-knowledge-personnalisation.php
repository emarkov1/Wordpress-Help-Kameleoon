...
<style>
    .searchBox{
      background-image: url("<?php bloginfo('template_directory'); ?>/img/background_perso.png");
      height: 260px;
    }
 </style>
...
<div class="tabs">
	<div class="container">
		<ul class="nav nav-tabs">
            <li class="col-xs-4"><a data-toggle="tab" href="#menu1"><?php $idObj = get_category_by_slug('knowledge-a-b-test'); $id = $idObj->term_id; echo get_cat_name($id) ?></a></li>
            <li class="col-xs-4 active"><a data-toggle="tab" href="#menu2"><?php $idObj = get_category_by_slug('knowledge-personnalisation'); $id = $idObj->term_id; echo get_cat_name($id) ?></a></li>
