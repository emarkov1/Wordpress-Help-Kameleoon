...
<div class="tabs">
	<div class="container">
		<ul class="nav nav-tabs">
            ...
            <li class="col-xs-4 active"><a data-toggle="tab" href="#menu2"><?php echo get_cat_name(get_cat_ID( 'Personnalisation' ));?></a></li>
            <li class="col-xs-4"><a data-toggle="tab" href="#menu3"><?php echo get_cat_name(get_cat_ID( 'Audiences' ));?></a></li>
        </ul>
	</div>
</div>
