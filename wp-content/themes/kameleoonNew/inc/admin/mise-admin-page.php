...
class Mise_Admin {
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					...
					<a href="<?php echo esc_url( apply_filters( 'mise_pro_theme_url', 'https://crestaproject.com/demo/mise/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'mise' ); ?></a>
					
					<a href="<?php echo esc_url( apply_filters( 'mise_pro_theme_url', 'https://crestaproject.com/demo/mise-pro/' ) ); ?>" class="button button-primary docs" target="_blank"><?php esc_html_e( 'View PRO version Demo', 'mise' ); ?></a>
	...
	public function documentation_screen() {
		...
		<div class="wrap about-wrap">
						...
						<ul>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'Watch the video to set the onepage template on the home page, or read the step-by-step instructions below.', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/025dPOpSorg" frameborder="0" allowfullscreen></iframe>
								</div>
							</li>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( '1) Create a new page and name it as you like (eg. My Home Page). In the "Page Attributes" section choose the template called "One Page Website" and save the page.', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
							...
							<li>
								<div class="miseDocText">
									<?php esc_html_e( '2) Go in your WordPress Dashboard under "Settings-> Reading". Set the "Front page displays" on "Static Page" and choose the page you previously created as Front page (eg. My Home Page).', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
				...
				<div class="singleToggle">
					...
					<div class="toggleText">
						<ul>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'Watch the video to set the "About Us" section, or read the step-by-step instructions below.', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/obK6KjgxhNg" frameborder="0" allowfullscreen></iframe>
								</div>
							</li>
							<li>
								<div class="miseDocText">
			...
			<div class="option-panel-toggle">
				<div class="singleToggle">
					<span class="dashicons dashicons-arrow-right"></span><div class="toggleTitle"><?php esc_html_e( 'Can I use a page builder plugin?', 'mise' ); ?></div>
					<div class="toggleText">
						<ul>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'Yes, the theme is compatible with Elementor Page Builder, SiteOrigin and Beaver Builder plugins. Just create or edit the page you want to use the page builder and choose the template called "Full Width for page builders". This template allows page builders to have maximum page customization (only the menu and the footer will be visible).', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
									<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/images/mise-documentation-16.png'; ?>" />
								</div>
							</li>
						</ul>
					</div>
			...
			<div class="option-panel-toggle">
				<div class="singleToggle">
					<span class="dashicons dashicons-arrow-right"></span><div class="toggleTitle"><?php esc_html_e( 'How to highlight a menu item', 'mise' ); ?></div>
					<div class="toggleText">
						<ul>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'If you need to emphasize a menu item (call to action, donate button, etc..) just go to your WordPress Dashboard under "Appearance-> Menus". Create a new "Custom Links" and drag it into the menu. Expand the entry and in the "CSS Classes" section write: crestaMenuButton', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
									<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/images/mise-documentation-14.png'; ?>" />
								</div>
							</li>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'This will be the result (the colors change according to the ones chosen).', 'mise' ); ?>
								</div>
								<div class="miseDocImage">
									<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/images/mise-documentation-15.png'; ?>" />
								</div>
							</li>
						</ul>
					</div>
				...
				<tbody>
					...
					<tr>
						...
						<td class="btn-wrapper">
							<a href="<?php echo esc_url( apply_filters( 'mise_pro_theme_url', 'https://crestaproject.com/demo/mise-pro/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'View PRO version demo', 'mise' ); ?></a>
