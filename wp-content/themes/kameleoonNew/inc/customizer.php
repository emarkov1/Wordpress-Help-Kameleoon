 ...
 */
function mise_customize_preview_js() {
	wp_enqueue_script( 'mise_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'mise_customize_preview_js' );

function mise_customizer_script() {
	wp_enqueue_script( 'mise-customizer-script', get_template_directory_uri() .'/js/customizer-script.js', array('jquery'),'', true  );
	wp_enqueue_style( 'mise-customizer-style', get_template_directory_uri() .'/inc/css/customizer-style.css');	
...
function mise_custom_settings_register( $wp_customize ) {
	...
	*/
	...
	$wp_customize->add_control('mise_theme_options[_onepage_shortcode_contact]', array(
		...
		'description'	=> wp_kses_post( 'Paste the contact form shortcode. For example the Contact Form 7 plugin shortcode: <code>[contact-form-7 id="xxx" title="Contact form 1"]</code>', 'mise' ),
        'section'    => 'cresta_mise_onepage_section_contact',
...
function mise_selective_refresh_phrase_cta() {
	return esc_html(mise_options('_onepage_phrase_cta'));
}
...
function mise_customize_register( $wp_customize ) {
	...
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_aboutus]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_aboutus]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_features]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_features]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_skills]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_skills]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_services]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_services]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_blog]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_blog]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_team]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_team]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_title_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtitle_contact]' )->transport  = 'postMessage';
	/* Onepage slider section */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_text_1_slider]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_text_2_slider]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_text_3_slider]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtext_1_slider]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtext_2_slider]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_subtext_3_slider]' )->transport  = 'postMessage';
	/* Onepage about us section */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textbutton_aboutus]' )->transport  = 'postMessage';
	/* Onepage features section */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_boxtextbutton_1_features]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_boxtextbutton_2_features]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_boxtextbutton_3_features]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_boxtextbutton_4_features]' )->transport  = 'postMessage';
	/* Onepage CTA section */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_phrase_cta]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_desc_cta]' )->transport  = 'postMessage';
	/* Onepage services section */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_phrase_services]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textarea_services]' )->transport  = 'postMessage';
	/* Onepage contact section */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_additionaltext_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyname_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyaddress1_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyaddress2_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyaddress3_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyphone_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyfax_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_companyemail_contact]' )->transport  = 'postMessage';
	/* Theme options social network float text */
	$wp_customize->get_setting( 'mise_theme_options[_social_float_text]' )->transport  = 'postMessage';
	/* Onepage about us color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_aboutus]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_aboutus]' )->transport  = 'postMessage';
	/* Onepage features color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_features]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_features]' )->transport  = 'postMessage';
	/* Onepage skills color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_skills]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_skills]' )->transport  = 'postMessage';
	/* Onepage cta color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_cta]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_cta]' )->transport  = 'postMessage';
	/* Onepage services color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_services]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_services]' )->transport  = 'postMessage';
	/* Onepage blog color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_blog]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_blog]' )->transport  = 'postMessage';
	/* Onepage team color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_team]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_team]' )->transport  = 'postMessage';
	/* Onepage contact color and background */
	$wp_customize->get_setting( 'mise_theme_options[_onepage_imgcolor_contact]' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'mise_theme_options[_onepage_textcolor_contact]' )->transport  = 'postMessage';
}
...
if( class_exists( 'WP_Customize_Control' ) ):
	class Mise_Customize_Upgrade_Control extends WP_Customize_Control {
        public function render_content() {  ?>
        	<p class="mise-custom-title">
        		<span class="customize-control-title">
					<h3 style="text-align:center;"><div class="dashicons dashicons-megaphone"></div> <?php esc_html_e('Thank you for using Mise WordPress Theme', 'mise'); ?></h3>
        		</span>
        	</p>
			<p style="text-align:center;" class="mise-custom-button">
				<a style="margin: 10px;display: block;" target="_blank" href="<?php echo esc_url(admin_url('themes.php?page=mise-welcome&tab=documentation')); ?>" class="button button-secondary">
					<?php esc_html_e('Theme Documentation', 'mise'); ?>
				</a>
				<a style="margin: 10px;display: block;" target="_blank" href="http://crestaproject.com/demo/mise/" class="button button-secondary">
					<?php esc_html_e('Watch the demo', 'mise'); ?>
				</a>
				<a style="margin: 10px;display: block;" target="_blank" href="http://crestaproject.com/demo/mise-pro/" class="button button-secondary">
					<?php esc_html_e('Watch the PRO Version demo', 'mise'); ?>
				</a>
				<a style="margin: 10px;display: block;" target="_blank" href="https://crestaproject.com/downloads/mise/" class="button button-secondary">
					<?php esc_html_e('More info about Mise theme', 'mise'); ?>
				</a>
			</p>
			<?php
        }
    }
	class Mise_Customize_Heading extends WP_Customize_Control {
		public $type = 'heading';

		public function render_content() {
			if ( !empty( $this->label ) ) : ?>
				<h3 class="mise-accordion-section-title"><?php echo esc_html( $this->label ); ?></h3>
			<?php endif;
			if($this->description){ ?>
	...
	class Mise_Info_Text extends WP_Customize_Control{
		public function render_content(){
		?>
	...
	class Mise_Fontawesome_Icon extends WP_Customize_Control{
		public $type = 'icon';
		public function render_content(){
			?>
				<label>
					...
					<?php } ?>
					<div class="mise-selected-icon">
						<i class="fa <?php echo esc_attr($this->value()); ?>"></i>
						<span><i class="fa fa-angle-down"></i></span>
					</div>
					<ul class="mise-icon-list clearfix">
						<?php
						$mise_font_awesome_icon_array = mise_font_awesome_icon_array();
						foreach ($mise_font_awesome_icon_array as $mise_font_awesome_icon) {
							$icon_class = $this->value() == $mise_font_awesome_icon ? 'icon-active' : '';
							echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($mise_font_awesome_icon).'"></i></li>';
						}
						?>
					</ul>
...
function mise_is_slider_active() {
	$showSlider = mise_options('_onepage_section_slider', '1');
	if ($showSlider == 1) {
		return true;
	}
	return false;
...
function mise_is_aboutus_active() {
	$showAbout = mise_options('_onepage_section_aboutus', '');
	if ($showAbout == 1) {
		return true;
	}
	return false;
...
function mise_is_features_active() {
...
function mise_is_skills_active() {
...
function mise_is_services_active() {
...
function mise_is_contact_active() {
...
function mise_sanitize_checkbox( $input ) {
	if ( $input == 1 ) {
		return 1;
	} else {
		return '';
...
function mise_sanitize_text( $input ) {
	return wp_kses($input, mise_allowed_html());
}

function mise_sanitize_select( $input, $setting ) {
	$input = sanitize_key( $input );
	$choices = $setting->manager->get_control( $setting->id )->choices;
	return ( array_key_exists( $input, $choices ) ? $input : $setting->default );
}

if( ! function_exists('mise_font_awesome_icon_array')){
	function mise_font_awesome_icon_array(){
...
if( ! function_exists('mise_show_social_network')){
	function mise_show_social_network($position) {
		$openLinks = mise_options('_social_open_links', '_self');
		$facebookURL = mise_options('_facebookurl', '');
		$twitterURL = mise_options('_twitterurl', '');
		$googleplusURL = mise_options('_googleplusurl', '');
		$linkedinURL = mise_options('_linkedinurl', '');
		$instagramURL = mise_options('_instagramurl', '');
		$youtubeURL = mise_options('_youtubeurl', '');
		$pinterestURL = mise_options('_pinteresturl', '');
		$tumblrURL = mise_options('_tumblrurl', '');
		$flickrURL = mise_options('_flickrurl', '');
		$vkURL = mise_options('_vkurl', '');
		$xingURL = mise_options('_xingurl', '');
		$redditURL = mise_options('_redditurl', '');
		$okruURL = mise_options('_okruurl', '');
		?>
		<div class="<?php echo $position == 'float' ? 'site-social' : 'site-social-footer' ?>">
			<?php if ($position == 'float') : ?>
				<?php $floatText = mise_options('_social_float_text', ''); ?>
				<?php if ($floatText || is_customize_preview()) : ?>
					<div class="socialText"><span><?php echo esc_html($floatText); ?></span></div>
				<?php endif; ?>
			<?php endif; ?>
			<?php if ($facebookURL) : ?>
				<a href="<?php echo esc_url($facebookURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Facebook', 'mise' ); ?>"><i class="fa fa-facebook spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Facebook', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($twitterURL) : ?>
				<a href="<?php echo esc_url($twitterURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Twitter', 'mise' ); ?>"><i class="fa fa-twitter spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Twitter', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($googleplusURL) : ?>
				<a href="<?php echo esc_url($googleplusURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Google Plus', 'mise' ); ?>"><i class="fa fa-google-plus spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Google Plus', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($linkedinURL) : ?>
				<a href="<?php echo esc_url($linkedinURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Linkedin', 'mise' ); ?>"><i class="fa fa-linkedin spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Linkedin', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($instagramURL) : ?>
				<a href="<?php echo esc_url($instagramURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Instagram', 'mise' ); ?>"><i class="fa fa-instagram spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Instagram', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($youtubeURL) : ?>
				<a href="<?php echo esc_url($youtubeURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'YouTube', 'mise' ); ?>"><i class="fa fa-youtube spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'YouTube', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($pinterestURL) : ?>
				<a href="<?php echo esc_url($pinterestURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Pinterest', 'mise' ); ?>"><i class="fa fa-pinterest spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Pinterest', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($tumblrURL) : ?>
				<a href="<?php echo esc_url($tumblrURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Tumblr', 'mise' ); ?>"><i class="fa fa-tumblr spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Tumblr', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($flickrURL) : ?>
				<a href="<?php echo esc_url($flickrURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Flickr', 'mise' ); ?>"><i class="fa fa-flickr spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Flickr', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($vkURL) : ?>
				<a href="<?php echo esc_url($vkURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'VK', 'mise' ); ?>"><i class="fa fa-vk spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'VK', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($xingURL) : ?>
				<a href="<?php echo esc_url($xingURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Xing', 'mise' ); ?>"><i class="fa fa-xing spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Xing', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($redditURL) : ?>
				<a href="<?php echo esc_url($redditURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Reddit', 'mise' ); ?>"><i class="fa fa-reddit-alien spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Reddit', 'mise' ); ?></span></i></a>
			<?php endif; ?>
			<?php if ($okruURL) : ?>
				<a href="<?php echo esc_url($okruURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'OK.ru', 'mise' ); ?>"><i class="fa fa-odnoklassniki spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'OK.ru', 'mise' ); ?></span></i></a>
			<?php endif; ?>
		</div>
		<?php
	}
...
if( ! function_exists('mise_allowed_html')){
	function mise_allowed_html() {
		$allowed_tags = array(
			'a' => array(
				'class' => array(),
				'id'    => array(),
...
if( ! function_exists('mise_loadingPage')){
	function mise_loadingPage () {
		echo '<div class="mLoader1"></div>';
	}
}

if( ! function_exists('mise_options')){
	function mise_options($name, $default = false) {
		$options = ( get_option( 'mise_theme_options' ) ) ? get_option( 'mise_theme_options' ) : null;
		// return the option if it exists
		if ( isset( $options[ $name ] ) ) {
			return apply_filters( "mise_theme_options_{$name}", $options[ $name ] );
		}
		// return default if nothing else
		return apply_filters( "mise_theme_options_{$name}", $default );
	}
}
 ...
 */
function mise_custom_css_styles() {
...
add_action('wp_head', 'mise_custom_css_styles');