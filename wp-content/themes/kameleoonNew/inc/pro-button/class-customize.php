...
final class Mise_Updgrade_Pro_Button {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Mise_Updgrade_Section_Pro' );
		...
		$manager->add_section(
			new Mise_Updgrade_Section_Pro(
				...
				array(
					'priority' => 1,
					'title'    => esc_html__( 'Mise PRO Theme', 'mise' ),
					'pro_text' => esc_html__( 'More Info',         'mise' ),
					'pro_url'  => 'https://crestaproject.com/downloads/mise/'
				)
			)
		);
		$manager->add_section(
		...
		$manager->add_section(
			new Mise_Updgrade_Section_Pro(
				$manager,
				'cresta_mise_locked_pro',
				array(
					'priority' => 1,
					'title'    => esc_html__( 'Change sections position', 'mise' ),
					'pro_text' => esc_html__( 'PRO Version',         'mise' ),
					'pro_url'  => 'https://crestaproject.com/downloads/mise/',
